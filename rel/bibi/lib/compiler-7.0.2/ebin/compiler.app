...
{application,compiler,
             [{description,"ERTS  CXC 138 10"},
              {vsn,"7.0.2"},
              {id,[]},
              {modules,[beam_a,beam_asm,beam_block,beam_bool,beam_bs,beam_bsm,
                        ...
                        cerl_sets,cerl_trees,compile,core_lib,core_lint,
                        core_parse,core_pp,core_scan,erl_bifs,rec_env,
                        sys_core_dsetel,sys_core_fold,sys_core_fold_lists,
                        sys_core_inline,sys_pre_attributes,v3_codegen,v3_core,
